...
class BATCH():
    ...
    def execute(self):
        ...
        Steps through each of the main files to do all the buildup calculations with results stored
        in csv files including a summary file for each buildup.

        :return: a list of summary files for each buildup
        """
