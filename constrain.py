...
if __name__ == '__main__':
    ...
    cap1 = [('Mar 19 2009', (9.999950922, 0.000000400, 50, 31.4)),
            ...
            ('Jul 31 2025', (9.9999513, 0.00000070/4, 50, 27.75))  # 'divide by 4' forces line towards the last point
            ]
    ...
    ah11d1 = PRIMCAL(cap4, coefficient4, std_temperature, equation4, '#1 AH11D 100 pF', 100, weight=True)
