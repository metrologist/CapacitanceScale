...
class REFERENCE():
    def __init__(self):  # built in external calibrations
        ...
        self.ah11a1 = PRIMCAL(cap1, coefficient1, std_temperature, equation1, '#1 AH11A 10 pF', 10)
        self.ah11b1 = PRIMCAL(cap2, coefficient2, std_temperature, equation2, '#1 AH11B 10 pF', 10)
        self.ah11c1 = PRIMCAL(cap3, coefficient3, std_temperature, equation3, '#1 AH11C 100 pF', 100)
        self.ah11d1 = PRIMCAL(cap4, coefficient4, std_temperature, equation4, '#1 AH11D 100 pF', 100)
