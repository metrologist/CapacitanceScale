...
As of October 2021 this reference capacitance is just a convenience to allow for post-processing to impose a
time-dependent constraint on the mean of the relative values of the four AH11 capacitors in frame 1. The expanded
uncertainty should be based on the uncertainty in the constraint rather than the historical certificate uncertainty.
