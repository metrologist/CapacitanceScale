...
@pytest.fixture
def lead1():
    return LEAD('lead1', (0.286, 0.782e-6), (255.2e-12, 2.8e-10), 1e4, 0.05)  # hv1

@pytest.fixture
def lead2():
    return LEAD('lead2', (0.302, 0.616e-6), (93.6e-12, 2.0e-10), 1e4, 0.05)  # lv1
...
@pytest.fixture
def cap():
    return CAPACITOR('cap', (0, 100e-12), (2.06e-9, 1.041e-10), (5.7e-10, 8.77e-11), 1e4, 0.01)  # AH11C1

def test_lead_correction(lead1, lead2):
